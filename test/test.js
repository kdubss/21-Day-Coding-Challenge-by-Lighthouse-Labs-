...
const getDistance4getDistance4CellsOnSameColumn = require("../functions/calcDistance").getDistance4CellsOnSameColumn;
...
describe("Testing behavioural functionality of day 21 challenge", () => {
  ...
  describe("getDistance4CellsOnSameColumn() function", () => {
    it("should be defined", () => {
      assert.isDefined(getDistance4getDistance4CellsOnSameColumn)
    });
    it("should be a function", () => {
      assert.isFunction(getDistance4getDistance4CellsOnSameColumn);
    });
    it("should return 9 as a distance", () => {
